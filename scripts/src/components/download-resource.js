...
export default class {
  ...
  _createSearchFunction (datasets) {
    const keys = ['title', 'notes', 'maintainer', 'tags', 'pub_date', 'author', 'author_email']
...
git@github.com:datascientiafoundation/LiveData-KGE.git
*/

import { Octokit } from "octokit";

const octokit = new Octokit({
  auth: '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'
})

const response = await octokit.request('GET /repos/datascientiafoundation/LiveData-KGE/contents/README.md', {
  owner: 'datascientiafoundation',
  repo: 'LiveData-KGE',
  path: 'README.md',
  headers: {
